...
(function () {
    ['js/accounts.js', 'js/funded.js', 'js/calendar.js', 'js/polish.js', 'js/share.js', 'js/palette.js', 'js/extra.js', 'js/momentum.js', 'js/report.js', 'js/level.js', 'js/round.js'].forEach(src => {
